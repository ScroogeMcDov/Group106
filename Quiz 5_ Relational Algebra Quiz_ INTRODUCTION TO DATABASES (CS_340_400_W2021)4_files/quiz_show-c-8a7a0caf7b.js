(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[580],{"1Lgu":function(e,s,n){"use strict"
var t=n("pQTu")
var a=n("m0r6")
...
n("p6Wi")
let c={}
function u(){const e=l()
g(0==e.find("#body").val().length||0==e.find(".student:not(.blank):visible").length)}window.messageStudents=function(e){const s=l()
c=e
s.find(".message_types").empty()
for(let n=0,t=e.options.length;n<t;n++){const t=d()("<option/>")
const a=e.options[n]
t.val(n).text(a.text)
...
c.attr("title",r).append(d()("<span class='screenreader-only'></span>").text(r))
...
a.append(n.show())
i[s.id]=n}a.show()
const m=_.t("Message Students for %{course_name}",{course_name:n})
...
s.dialog({width:600,modal:true,open:(e,n)=>{s.closest(".ui-dialog").attr("role","dialog").attr("aria-label",m)},close:(e,n)=>{s.closest(".ui-dialog").removeAttr("role").removeAttr("aria-label")}}).dialog("open").dialog("option","title",m).on("dialogclose",e.onClose)}
...
e.recipients=s.join(",")
return e},beforeSubmit(e){m(true)
...
d()("#message_students_dialog").dialog("close")},error(e){m(false)
...
let i=[]
t&&(n&&n.callback?i=n.callback.call(window.messageStudents,a,_):c.callback&&(i=c.callback.call(window.messageStudents,n.text,a,_)))
c.subjectCallback&&e.find("[name=subject]").val(c.subjectCallback(n.text,a))
e.find(".cutoff_holder").showIf(n.cutoff)
e.find(".student_list").toggleClass("show_score",!!(n.cutoff||n.score))
m(0===i.length)
const d=new Set(i)
Object.entries(t).forEach(([e,s])=>{s.showIf(d.has(e))})}
...
function m(e,s){null==s&&(s=l().find("button"))
s.toggleClass("disabled",e).attr("aria-disabled",e)}function g(e){m(e,l().find(".send_button"))}function l(){return d()("#message_students_dialog")}s["a"]=messageStudents},lkPJ:function(e,s,n){"use strict"
var t=n("ouhR")
var a=n.n(t)
...
s["a"]=_},wWL5:function(e,s,n){"use strict"
n.r(s)
var t=n("ouhR")
var a=n.n(t)
var _=n("lkPJ")
...
var b=n("ppA4")
var v=n("6V2X")
a()(document).ready((function(){ENV.QUIZ_SUBMISSION_EVENTS_URL&&Object(l["a"])(true)
...
const t=d["a"].t("students_who_have_taken_the_quiz","Students who have taken the quiz")
const a=d["a"].t("students_who_have_not_taken_the_quiz","Students who have NOT taken the quiz")
const _=new c["a"]({context:ENV.QUIZ.title,recipientGroups:[{name:t,recipients:n},{name:a,recipients:s}]})
_.open()})})
function t(e,s=true){e&&e.preventDefault()
o.a.render(Object(i["a"])(b["a"],{open:s,sourceCourseId:ENV.COURSE_ID,contentShare:{content_type:"quiz",content_id:ENV.QUIZ.id},onDismiss:()=>{t(null,false)
...
o.a.render(Object(i["a"])(v["a"],{open:s,sourceCourseId:ENV.COURSE_ID,contentSelection:{quizzes:[ENV.QUIZ.id]},onDismiss:()=>{r(null,false)
...
a()("#publish_quiz_form").formSubmit({beforeSubmit(e){a()(this).find("button").attr("disabled",true).text(d["a"].t("buttons.publishing","Publishing..."))},success(e){a()(this).find("button").text(d["a"].t("buttons.already_published","Published!"))
location.reload()}})
const h=a()("#quiz-publish-link")
const k=new m["a"](a.a.extend(ENV.QUIZ,{unpublishable:!h.hasClass("disabled")}))
const y=new g["a"]({model:k,el:h})
...
f["default"].init(w,j)
a()("#assignment_external_tools").length&&p["a"].attach(a()("#assignment_external_tools")[0],"assignment_view",parseInt(ENV.COURSE_ID,10),parseInt(ENV.QUIZ.assignment_id,10))}))
n("2wuA")
n("/j35")
var h=n("y8OA")
...
e.css({height:"auto"})})
e.disableWhileLoading(s)}a()("#module_sequence_footer").moduleSequenceFooter({courseID:ENV.COURSE_ID,assetType:"Quiz",assetID:ENV.QUIZ.id,location:location})})},ysUD:function(e,s,n){"use strict"
n.d(s,"a",(function(){return z}))
var t=n("VTBJ")
var a=n("rePB")
var _=n("1OyB")
var i=n("vuIU")
...
var v=n("sQ3t")
var h=n("jtGx")
function k(e){var s=e.colors,n=e.borders,t=e.stacking
return{zIndex:t.topmost,background:"rgba(255, 255, 255, 0.75)",borderColor:"transparent",focusBorderColor:s.borderBrand,borderRadius:n.radiusMedium,borderWidth:n.widthSmall}}k.canvas=function(e){return{focusBorderColor:e["ic-brand-primary"]}}
var y,S,w,j
...
var z=(y=Object(b["j"])(k,E),y(S=(j=w=function(e){Object(d["a"])(n,e)
var s=Object(r["a"])(n)
function n(){var e
Object(_["a"])(this,n)
for(var t=arguments.length,a=new Array(t),i=0;i<t;i++)a[i]=arguments[i]
e=s.call.apply(s,[this].concat(a))
e.handleElementRef=function(s){e.props.elementRef(s)}
e.contentRef=function(s){e._content=s}
return e}Object(i["a"])(n,[{key:"componentDidMount",value:function(){this.props.fullscreen&&p.a.on()}},{key:"componentWillUnmount",value:function(){this.props.fullscreen&&p.a.off()}},{key:"render",value:function(){var e
var s=Object(v["a"])(this.props.children,{ref:this.contentRef})
var _=l()((e={},Object(a["a"])(e,E.root,true),Object(a["a"])(e,E[this.props.placement],true),Object(a["a"])(e,E.fullscreen,this.props.fullscreen),e))
var i=Object(t["a"])({},Object(h["a"])(this.props,n.propTypes),{className:_,ref:this.handleElementRef})
if("function"===typeof this.props.onClick){i.onClick=this.props.onClick
i.tabIndex=-1}return c.a.createElement("span",i,s)}}])
n.displayName="Mask"
return n}(o["Component"]),w.propTypes={onDismiss:m.a.func,placement:m.a.oneOf(["top","center","bottom","stretch"]),fullscreen:m.a.bool,children:m.a.node,onClick:m.a.func,elementRef:m.a.func},w.defaultProps={placement:"center",fullscreen:false,onDismiss:void 0,children:null,onClick:void 0,elementRef:function(e){}},j))||S)}}])

//# sourceMappingURL=quiz_show-c-8a7a0caf7b.js.map